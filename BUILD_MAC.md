...
2. Внизу страницы в блоке **Artifacts** нажмите **ConvMac-macos** — скачается архив.
3. Распакуйте архив: внутри будет папка **ConvMac.app**.
4. Перенесите **ConvMac.app** на Mac (флешка, облако, AirDrop) и запускайте двойным кликом.
