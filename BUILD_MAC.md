...
2. Внизу в **Artifacts** будут два артефакта:
   - **ConvMac-macos-AppleSilicon** — для Mac на чипе M1/M2/M3;
   - **ConvMac-macos-Intel** — для Mac на процессоре Intel.
   Скачайте тот, что под ваш компьютер.
3. Скачанный файл без расширения — переименуйте в **`.zip`** и распакуйте. Внутри будет папка **ConvMac.app**.
4. Перенесите **ConvMac.app** на Mac и запускайте двойным кликом.
